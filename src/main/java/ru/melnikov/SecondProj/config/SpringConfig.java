package ru.melnikov.SecondProj.config;
...
@Configuration
@ComponentScan("ru.melnikov.SecondProj")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableTransactionManagement
@EnableJpaRepositories("ru.melnikov.SecondProj.repositories")
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("ru.melnikov.SecondProj.models");
